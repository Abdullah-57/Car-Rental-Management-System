...
public class Corporate implements Rent
{
    private int id;
    private String name;
    ...
    private final String feature;       // final variable to fix the Feature available for Corporate Renters
    ...
    public Corporate()
    {
        ...
        this.phoneNumber = 0;
        this.address = "";
        this.feature = "Special rates for Corporate Clients.";
        this.featureDiscount = 0.0;
        this.rentedCars = new ArrayList<>();
    }

    // Parameterized Constructor
    public Corporate(int id, String name, String email, double totalRentalFee, int phoneNumber, String address)
    {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public Corporate(int id, String name, String email, double totalRentalFee, int phoneNumber, String address, List<Car> rentedCars)
    {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    // Calculate Rent for Corporate Customers
    @Override
    public void calculateRent(Car car)
    {
        if ((car.getLuxuryStatus() == true) && (car.isDamageStatus() == true) && (car.getInsuranceStatus() == true))
        {
            ...
            featureDiscount = 0.35 * car.getDummyRentalFee();
            ...
            System.out.println("Corporate Client Discount: PKR" + featureDiscount + " from Rental Fee");
        }
        ...
        else if ((car.getInsuranceStatus() == true) && (car.isDamageStatus() == true))
        {
            ...
            totalRentalFee = totalRentalFee - car.getInsuranceCost();
            featureDiscount = 0.35 * car.getDummyRentalFee();
            totalRentalFee -= featureDiscount;
            car.setRentalFee(totalRentalFee);
